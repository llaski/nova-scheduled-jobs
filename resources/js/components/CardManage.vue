<template>
    <div>
        <card class="h-auto mb-4 overflow-scroll">
                    ...
                    <tr v-for="(job, index) in jobs" :job="job">
                        ...
                        <td>
                            <button
                                ...
                                :class="canDispatchCommand(job.dispatch) ? 'text-70 hover:text-primary' : 'cursor-default text-40'"
                                :disabled="!canDispatchCommand(job.dispatch)"
...
export default {
    ...
    methods: {
        ...
        canDispatchCommand(dispatch) {
            if(dispatch){
                return ['command', 'job'].indexOf(dispatch) >= 0;
            }
